...
function onError(msg) {
    logger.error('Redis error:', msg.message);
}
redisClient.on('error', onError);
redisPubSub.on('error', onError);
...
var socket = new Socket(config, sockjs, sessionFactory, redisPubSub, httpRequestRouter, SocketDataHandler, logger, stats);
