module.exports = function(config, sockjs, sessionFactory, connection, httpRequestRouter, SocketDataHandler, logger, stats) {
    var that = this;
            ...
            conn.once('data', function(sessionId) {
                ...
                sessionFactory.getSession(sessionId, function(err, session) {
                    if (err) {
                        ...
                        new SocketDataHandler(connection, httpRequestRouter, session, sessionId, conn, logger, stats);
